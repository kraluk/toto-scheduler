...
import com.kraluk.totoscheduler.domain.PersistentAuditEvent;
import com.kraluk.totoscheduler.repository.PersistenceAuditEventRepository;
import com.kraluk.totoscheduler.service.AuditEventService;
...
public class AuditResourceIntTest {
    ...
    public void getAuditsByDate() throws Exception {
        ...
        String
            fromDate =
            SAMPLE_TIMESTAMP.minusSeconds(SECONDS_PER_DAY).toString().substring(0, 10);

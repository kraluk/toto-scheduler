...
import com.kraluk.totoscheduler.config.ApplicationProperties;
...
public class TotoSchedulerApp {
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TotoSchedulerApp.class);

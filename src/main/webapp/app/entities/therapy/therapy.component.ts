...
export class TherapyComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Therapy) {
        return item.id;
    }
    registerChangeInTherapies() {
        this.eventSubscriber = this.eventManager.subscribe('therapyListModification', (response) => this.reset());
    }

...
export class TherapyTypeService {
    ...
    private resourceUrl = SERVER_API_URL + 'api/therapy-types';
    private resourceSearchUrl = SERVER_API_URL + 'api/_search/therapy-types';
    ...
    /**
     * Convert a returned JSON object to TherapyType.
     */
    private convertItemFromServer(json: any): TherapyType {
        const entity: TherapyType = Object.assign(new TherapyType(), json);
        return entity;
    }

    /**
     * Convert a TherapyType to a JSON which can be sent to the server.
     */
